...
public class TC_JOOMLA_WEBLINKS_002 extends TestHelper {
	...
	String title = "Test Weblink 1"+Utilities.timer_hhmmss();
	String url = "http://www.joomla.org";
	String title_new = "Test Weblink 2"+Utilities.timer_hhmmss();
	...
	public void f() throws InterruptedException {
		...
		webLinksNewPage.createNew(title,Utilities.faker_title(),url,Utilities.faker_content(),webLinksNewPage.status_Unpublished);
